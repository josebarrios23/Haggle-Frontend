    ...
    <div>
      <div className="bg-white">
        <div>
          ...
          <div className="grid lg:grid-cols-1 md:gap-2 ml-48 pb-24">
            <div className="bg-gray-100/50  rounded-xl mx-10 my-10 shadow-2xl  backdrop-brightness-150 backdrop-blur-3xl bg-opacity-90 hover:bg-gray-100 w-3/4 ">
              <div className="grid grid-cols-4 h-full">
                <div className="bg-orange-500 rounded-tl-lg rounded-bl-lg text-5xl text-white flex items-center justify-center col-span-1">
                  JB
                </div>
